...
?>
					<?php 
						...
						$text1 = get_field('text_1') ?: __('Enter text here...', 'climatron');
						$text2 = get_field('text_2') ?: __('Enter text here...', 'climatron');
						$text3 = get_field('text_3') ?: __('Enter text here...', 'climatron');
					?>
